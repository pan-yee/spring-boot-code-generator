...
@Builder
public class WebRouterGeneratorStrategy extends AbstractTemplateStrategy {

    public static class Builder extends BaseBuilder {

        private final WebRouterGeneratorStrategy strategy = new WebRouterGeneratorStrategy();
         ...
         * 覆盖已有文件
         */
        public WebRouterGeneratorStrategy.Builder enableFileOverride() {
         ...
         * 开启lombok模型
         */
        public WebRouterGeneratorStrategy.Builder enableLombok() {
         ...
         * 开启swagger
         */
        public WebRouterGeneratorStrategy.Builder enableSwagger() {
         ...
         * 数据库表字段映射到实体的命名策略
         */
        public WebRouterGeneratorStrategy.Builder columnNaming(NamingStrategy namingStrategy) {
         ...
         * 数据库表映射到实体的命名策略
         */
        public WebRouterGeneratorStrategy.Builder naming(NamingStrategy namingStrategy) {
         ...
         * @param idType ID类型
         */
        public WebRouterGeneratorStrategy.Builder idType(IdType idType) {
         ...
         * 开启链式模型
         */
        public WebRouterGeneratorStrategy.Builder enableChainModel() {
         ...
         */
        public WebRouterGeneratorStrategy.Builder disableSerialVersionUID() {
         ...
         * 实体是否生成 TableField注解
         */
        public WebRouterGeneratorStrategy.Builder enableTableFieldAnnotation() {
         ...
         * @return this
         */
        public WebRouterGeneratorStrategy.Builder formatFileName(String format) {
         ...
         */
        public WebRouterGeneratorStrategy.Builder convertFileName(ConverterFileName converter) {
            this.strategy.setConverterFileName(converter);
            return this;
        }

        public WebRouterGeneratorStrategy get() {
            return strategy;
        }
    }
