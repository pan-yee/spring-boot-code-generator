...
@Builder
public class DtoGeneratorStrategy extends AbstractTemplateStrategy {

    public static class Builder extends BaseBuilder {

        private final DtoGeneratorStrategy strategy = new DtoGeneratorStrategy();
         ...
         * 覆盖已有文件
         */
        public DtoGeneratorStrategy.Builder enableFileOverride() {
         ...
         * 开启lombok模型
         */
        public DtoGeneratorStrategy.Builder enableLombok() {
         ...
         * 开启swagger
         */
        public DtoGeneratorStrategy.Builder enableSwagger() {
         ...
         * 数据库表字段映射到实体的命名策略
         */
        public DtoGeneratorStrategy.Builder columnNaming(NamingStrategy namingStrategy) {
         ...
         * 数据库表映射到实体的命名策略
         */
        public DtoGeneratorStrategy.Builder naming(NamingStrategy namingStrategy) {
         ...
         * @param idType ID类型
         */
        public DtoGeneratorStrategy.Builder idType(IdType idType) {
         ...
         * 开启链式模型
         */
        public DtoGeneratorStrategy.Builder enableChainModel() {
         ...
         */
        public DtoGeneratorStrategy.Builder disableSerialVersionUID() {
         ...
         * 实体是否生成 TableField注解
         */
        public DtoGeneratorStrategy.Builder enableTableFieldAnnotation() {
         ...
         * @return this
         */
        public DtoGeneratorStrategy.Builder formatFileName(String format) {
         ...
         */
        public DtoGeneratorStrategy.Builder convertFileName(ConverterFileName converter) {
            this.strategy.setConverterFileName(converter);
            return this;
        }

        public DtoGeneratorStrategy get() {
            return strategy;
        }
    }
