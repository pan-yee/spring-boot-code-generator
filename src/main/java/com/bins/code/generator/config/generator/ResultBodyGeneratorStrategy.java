...
@Builder
public class ResultBodyGeneratorStrategy extends AbstractTemplateStrategy {

    public static class Builder extends BaseBuilder {

        private final ResultBodyGeneratorStrategy strategy = new ResultBodyGeneratorStrategy();
         ...
         * 覆盖已有文件
         */
        public ResultBodyGeneratorStrategy.Builder enableFileOverride() {
         ...
         * 开启lombok模型
         */
        public ResultBodyGeneratorStrategy.Builder enableLombok() {
         ...
         * 开启swagger
         */
        public ResultBodyGeneratorStrategy.Builder enableSwagger() {
         ...
         * 数据库表字段映射到实体的命名策略
         */
        public ResultBodyGeneratorStrategy.Builder columnNaming(NamingStrategy namingStrategy) {
         ...
         * 数据库表映射到实体的命名策略
         */
        public ResultBodyGeneratorStrategy.Builder naming(NamingStrategy namingStrategy) {
         ...
         * @param idType ID类型
         */
        public ResultBodyGeneratorStrategy.Builder idType(IdType idType) {
         ...
         * 开启链式模型
         */
        public ResultBodyGeneratorStrategy.Builder enableChainModel() {
         ...
         */
        public ResultBodyGeneratorStrategy.Builder disableSerialVersionUID() {
         ...
         * 实体是否生成 TableField注解
         */
        public ResultBodyGeneratorStrategy.Builder enableTableFieldAnnotation() {
         ...
         * @return this
         */
        public ResultBodyGeneratorStrategy.Builder formatFileName(String format) {
         ...
         */
        public ResultBodyGeneratorStrategy.Builder convertFileName(ConverterFileName converter) {
            this.strategy.setConverterFileName(converter);
            return this;
        }

        public ResultBodyGeneratorStrategy get() {
            return strategy;
        }
    }
