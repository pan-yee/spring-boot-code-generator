...
@Builder
public class ServiceImplGeneratorStrategy extends AbstractTemplateStrategy {

    public static class Builder extends BaseBuilder {

        private final ServiceImplGeneratorStrategy strategy = new ServiceImplGeneratorStrategy();
         ...
         * 覆盖已有文件
         */
        public ServiceImplGeneratorStrategy.Builder enableFileOverride() {
         ...
         * 开启lombok模型
         */
        public ServiceImplGeneratorStrategy.Builder enableLombok() {
         ...
         * 开启swagger
         */
        public ServiceImplGeneratorStrategy.Builder enableSwagger() {
         ...
         * 数据库表字段映射到实体的命名策略
         */
        public ServiceImplGeneratorStrategy.Builder columnNaming(NamingStrategy namingStrategy) {
         ...
         * 数据库表映射到实体的命名策略
         */
        public ServiceImplGeneratorStrategy.Builder naming(NamingStrategy namingStrategy) {
         ...
         * @param idType ID类型
         */
        public ServiceImplGeneratorStrategy.Builder idType(IdType idType) {
         ...
         * 开启链式模型
         */
        public ServiceImplGeneratorStrategy.Builder enableChainModel() {
         ...
         */
        public ServiceImplGeneratorStrategy.Builder disableSerialVersionUID() {
         ...
         * 实体是否生成 TableField注解
         */
        public ServiceImplGeneratorStrategy.Builder enableTableFieldAnnotation() {
         ...
         * @return this
         */
        public ServiceImplGeneratorStrategy.Builder formatFileName(String format) {
         ...
         */
        public ServiceImplGeneratorStrategy.Builder convertFileName(ConverterFileName converter) {
            this.strategy.setConverterFileName(converter);
            return this;
        }

        public ServiceImplGeneratorStrategy get() {
            return strategy;
        }
    }
