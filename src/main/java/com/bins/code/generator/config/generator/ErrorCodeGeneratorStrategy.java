...
@Builder
public class ErrorCodeGeneratorStrategy extends AbstractTemplateStrategy {

    public static class Builder extends BaseBuilder {

        private final ErrorCodeGeneratorStrategy strategy = new ErrorCodeGeneratorStrategy();
         ...
         * 覆盖已有文件
         */
        public ErrorCodeGeneratorStrategy.Builder enableFileOverride() {
         ...
         * 开启lombok模型
         */
        public ErrorCodeGeneratorStrategy.Builder enableLombok() {
         ...
         * 开启swagger
         */
        public ErrorCodeGeneratorStrategy.Builder enableSwagger() {
         ...
         * 数据库表字段映射到实体的命名策略
         */
        public ErrorCodeGeneratorStrategy.Builder columnNaming(NamingStrategy namingStrategy) {
         ...
         * 数据库表映射到实体的命名策略
         */
        public ErrorCodeGeneratorStrategy.Builder naming(NamingStrategy namingStrategy) {
         ...
         * @param idType ID类型
         */
        public ErrorCodeGeneratorStrategy.Builder idType(IdType idType) {
         ...
         * 开启链式模型
         */
        public ErrorCodeGeneratorStrategy.Builder enableChainModel() {
         ...
         */
        public ErrorCodeGeneratorStrategy.Builder disableSerialVersionUID() {
         ...
         * 实体是否生成 TableField注解
         */
        public ErrorCodeGeneratorStrategy.Builder enableTableFieldAnnotation() {
         ...
         * @return this
         */
        public ErrorCodeGeneratorStrategy.Builder formatFileName(String format) {
         ...
         */
        public ErrorCodeGeneratorStrategy.Builder convertFileName(ConverterFileName converter) {
            this.strategy.setConverterFileName(converter);
            return this;
        }

        public ErrorCodeGeneratorStrategy get() {
            return strategy;
        }
    }
