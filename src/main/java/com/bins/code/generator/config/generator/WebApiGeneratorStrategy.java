...
@Builder
public class WebApiGeneratorStrategy extends AbstractTemplateStrategy {

    public static class Builder extends BaseBuilder {

        private final WebApiGeneratorStrategy strategy = new WebApiGeneratorStrategy();
         ...
         * 覆盖已有文件
         */
        public WebApiGeneratorStrategy.Builder enableFileOverride() {
         ...
         * 开启lombok模型
         */
        public WebApiGeneratorStrategy.Builder enableLombok() {
         ...
         * 开启swagger
         */
        public WebApiGeneratorStrategy.Builder enableSwagger() {
         ...
         * 数据库表字段映射到实体的命名策略
         */
        public WebApiGeneratorStrategy.Builder columnNaming(NamingStrategy namingStrategy) {
         ...
         * 数据库表映射到实体的命名策略
         */
        public WebApiGeneratorStrategy.Builder naming(NamingStrategy namingStrategy) {
         ...
         * @param idType ID类型
         */
        public WebApiGeneratorStrategy.Builder idType(IdType idType) {
         ...
         * 开启链式模型
         */
        public WebApiGeneratorStrategy.Builder enableChainModel() {
         ...
         */
        public WebApiGeneratorStrategy.Builder disableSerialVersionUID() {
         ...
         * 实体是否生成 TableField注解
         */
        public WebApiGeneratorStrategy.Builder enableTableFieldAnnotation() {
         ...
         * @return this
         */
        public WebApiGeneratorStrategy.Builder formatFileName(String format) {
         ...
         */
        public WebApiGeneratorStrategy.Builder convertFileName(ConverterFileName converter) {
            this.strategy.setConverterFileName(converter);
            return this;
        }

        public WebApiGeneratorStrategy get() {
            return strategy;
        }
    }
