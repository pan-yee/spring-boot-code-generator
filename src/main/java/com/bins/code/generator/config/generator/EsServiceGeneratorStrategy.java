...
@Builder
public class EsServiceGeneratorStrategy extends AbstractTemplateStrategy {

    public static class Builder extends BaseBuilder {

        private final EsServiceGeneratorStrategy strategy = new EsServiceGeneratorStrategy();
         ...
         * 覆盖已有文件
         */
        public EsServiceGeneratorStrategy.Builder enableFileOverride() {
         ...
         * 开启lombok模型
         */
        public EsServiceGeneratorStrategy.Builder enableLombok() {
         ...
         * 开启swagger
         */
        public EsServiceGeneratorStrategy.Builder enableSwagger() {
         ...
         * 数据库表字段映射到实体的命名策略
         */
        public EsServiceGeneratorStrategy.Builder columnNaming(NamingStrategy namingStrategy) {
         ...
         * 数据库表映射到实体的命名策略
         */
        public EsServiceGeneratorStrategy.Builder naming(NamingStrategy namingStrategy) {
         ...
         * @param idType ID类型
         */
        public EsServiceGeneratorStrategy.Builder idType(IdType idType) {
         ...
         * 开启链式模型
         */
        public EsServiceGeneratorStrategy.Builder enableChainModel() {
         ...
         */
        public EsServiceGeneratorStrategy.Builder disableSerialVersionUID() {
         ...
         * 实体是否生成 TableField注解
         */
        public EsServiceGeneratorStrategy.Builder enableTableFieldAnnotation() {
         ...
         * @return this
         */
        public EsServiceGeneratorStrategy.Builder formatFileName(String format) {
         ...
         */
        public EsServiceGeneratorStrategy.Builder convertFileName(ConverterFileName converter) {
            this.strategy.setConverterFileName(converter);
            return this;
        }

        public EsServiceGeneratorStrategy get() {
            return strategy;
        }
    }
