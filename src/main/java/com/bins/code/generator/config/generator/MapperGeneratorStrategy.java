...
@Builder
public class MapperGeneratorStrategy extends AbstractTemplateStrategy {

    public static class Builder extends BaseBuilder {

        private final MapperGeneratorStrategy strategy = new MapperGeneratorStrategy();
         ...
         * 覆盖已有文件
         */
        public MapperGeneratorStrategy.Builder enableFileOverride() {
         ...
         * 开启lombok模型
         */
        public MapperGeneratorStrategy.Builder enableLombok() {
         ...
         * 开启swagger
         */
        public MapperGeneratorStrategy.Builder enableSwagger() {
         ...
         * 数据库表字段映射到实体的命名策略
         */
        public MapperGeneratorStrategy.Builder columnNaming(NamingStrategy namingStrategy) {
         ...
         * 数据库表映射到实体的命名策略
         */
        public MapperGeneratorStrategy.Builder naming(NamingStrategy namingStrategy) {
         ...
         * @param idType ID类型
         */
        public MapperGeneratorStrategy.Builder idType(IdType idType) {
         ...
         * 开启链式模型
         */
        public MapperGeneratorStrategy.Builder enableChainModel() {
         ...
         */
        public MapperGeneratorStrategy.Builder disableSerialVersionUID() {
         ...
         * 实体是否生成 TableField注解
         */
        public MapperGeneratorStrategy.Builder enableTableFieldAnnotation() {
         ...
         * @return this
         */
        public MapperGeneratorStrategy.Builder formatFileName(String format) {
         ...
         */
        public MapperGeneratorStrategy.Builder convertFileName(ConverterFileName converter) {
            this.strategy.setConverterFileName(converter);
            return this;
        }

        public MapperGeneratorStrategy get() {
            return strategy;
        }
    }
