...
@Builder
public class MapperXmlGeneratorStrategy extends AbstractTemplateStrategy {

    public static class Builder extends BaseBuilder {

        private final MapperXmlGeneratorStrategy strategy = new MapperXmlGeneratorStrategy();
         ...
         * 覆盖已有文件
         */
        public MapperXmlGeneratorStrategy.Builder enableFileOverride() {
         ...
         * 开启lombok模型
         */
        public MapperXmlGeneratorStrategy.Builder enableLombok() {
         ...
         * 开启swagger
         */
        public MapperXmlGeneratorStrategy.Builder enableSwagger() {
         ...
         * 数据库表字段映射到实体的命名策略
         */
        public MapperXmlGeneratorStrategy.Builder columnNaming(NamingStrategy namingStrategy) {
         ...
         * 数据库表映射到实体的命名策略
         */
        public MapperXmlGeneratorStrategy.Builder naming(NamingStrategy namingStrategy) {
         ...
         * @param idType ID类型
         */
        public MapperXmlGeneratorStrategy.Builder idType(IdType idType) {
         ...
         * 开启链式模型
         */
        public MapperXmlGeneratorStrategy.Builder enableChainModel() {
         ...
         */
        public MapperXmlGeneratorStrategy.Builder disableSerialVersionUID() {
         ...
         * 实体是否生成 TableField注解
         */
        public MapperXmlGeneratorStrategy.Builder enableTableFieldAnnotation() {
         ...
         * @return this
         */
        public MapperXmlGeneratorStrategy.Builder formatFileName(String format) {
         ...
         */
        public MapperXmlGeneratorStrategy.Builder convertFileName(ConverterFileName converter) {
            this.strategy.setConverterFileName(converter);
            return this;
        }

        public MapperXmlGeneratorStrategy get() {
            return strategy;
        }
    }
