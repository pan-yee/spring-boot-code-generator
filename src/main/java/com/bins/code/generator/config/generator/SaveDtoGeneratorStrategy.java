...
@Builder
public class SaveDtoGeneratorStrategy extends AbstractTemplateStrategy {

    public static class Builder extends BaseBuilder {

        private final SaveDtoGeneratorStrategy strategy = new SaveDtoGeneratorStrategy();
         ...
         * 覆盖已有文件
         */
        public SaveDtoGeneratorStrategy.Builder enableFileOverride() {
         ...
         * 开启lombok模型
         */
        public SaveDtoGeneratorStrategy.Builder enableLombok() {
         ...
         * 开启swagger
         */
        public SaveDtoGeneratorStrategy.Builder enableSwagger() {
         ...
         * 数据库表字段映射到实体的命名策略
         */
        public SaveDtoGeneratorStrategy.Builder columnNaming(NamingStrategy namingStrategy) {
         ...
         * 数据库表映射到实体的命名策略
         */
        public SaveDtoGeneratorStrategy.Builder naming(NamingStrategy namingStrategy) {
         ...
         * @param idType ID类型
         */
        public SaveDtoGeneratorStrategy.Builder idType(IdType idType) {
         ...
         * 开启链式模型
         */
        public SaveDtoGeneratorStrategy.Builder enableChainModel() {
         ...
         */
        public SaveDtoGeneratorStrategy.Builder disableSerialVersionUID() {
         ...
         * 实体是否生成 TableField注解
         */
        public SaveDtoGeneratorStrategy.Builder enableTableFieldAnnotation() {
         ...
         * @return this
         */
        public SaveDtoGeneratorStrategy.Builder formatFileName(String format) {
         ...
         */
        public SaveDtoGeneratorStrategy.Builder convertFileName(ConverterFileName converter) {
            this.strategy.setConverterFileName(converter);
            return this;
        }

        public SaveDtoGeneratorStrategy get() {
            return strategy;
        }
    }
