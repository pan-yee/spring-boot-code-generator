...
@Data
public class EsServiceModel extends BaseModel implements ITemplate {

    private static final EsServiceModel model = new EsServiceModel();

    private EsServiceModel() {
        super();
    }

    public EsServiceModel(ConfigBuilder configBuilder) {
        super(configBuilder);
    }

    public static EsServiceModel getInstance() {
        return model;
    }
