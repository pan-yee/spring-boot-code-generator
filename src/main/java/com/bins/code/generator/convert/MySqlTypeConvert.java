...
import static com.bins.code.generator.config.rule.DbColumnType.*;
import static com.bins.code.generator.convert.TypeConverts.contains;
import static com.bins.code.generator.convert.TypeConverts.containsAny;
...
public class MySqlTypeConvert implements ITypeConvert {
    ...
    public IColumnType processTypeConvert(GlobalConfig config, String fieldType) {
        return TypeConverts.use(fieldType)
            ...
            .test(containsAny("tinyint(1)", "bit(1)").then(INTEGER))
